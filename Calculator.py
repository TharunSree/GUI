...
exp = Button(button_frame, font=('times new roman', 12), text=' ^ ', bd=1, relief='ridge',
             fg='black', bg='#e6ecff', command=lambda: press("**"), height=3, width=8)

equal = Button(button_frame, font=('times new roman', 12), text=' = ', bd=1, relief='ridge',
               fg='black', bg='#e6ecff', command=equalpress, height=3)

delete = Button(button_frame, font=('times new roman', 12), text='Del', bd=1, relief='ridge',
               fg='black', bg='#e6ecff', command=delt, height=3,width=8)
